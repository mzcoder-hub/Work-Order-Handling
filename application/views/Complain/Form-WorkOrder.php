            ...
            <div class="col-xl-12 col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo site_url('workorder/add') ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      type="number" name="NPK" placeholder="Isi NPK Kamu..." />
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      type="text" name="Divisi" placeholder="Isi Divisi Kamu..." />
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      type="text" name="Department" placeholder="Isi Department Kamu..." />
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      type="text" name="Nama_Atasan" placeholder="Isi Nama Atasan Kamu..." />
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      type="text" name="Subject_Abnormality" placeholder="Isi Subject Abnormality Kamu..." />
                      <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control <?php echo form_error('Keterangan_Abnormality') ? 'is-invalid':'' ?>"
                       name="Keterangan_Abnormality" placeholder="Isi Abnormality..."></textarea>
                       <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control-file <?php echo form_error('images') ? 'is-invalid':'' ?>"
